...
#########################################
## AGORA intervalo de confiança 90% CONFIANÇA
...
print('Intervalo de confiança com 90% :  ', intervaloconfianca)
print("-----------------------------------")

#########
""" significa que temos 90% de confiança que a media salarial das 
pessoas do Brasil é de 9695,26 até 10.113,51, isso na tendencia central
"""
