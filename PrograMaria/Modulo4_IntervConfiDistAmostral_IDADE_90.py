...
###################################################
## AGORA intervalo de confiança 90% com as IDADES
###################################################
...
# nível de confiança
niveldeconfianca = 0.90
tamanhoamostra=len(idades)
print("Tamanho amostra: ",tamanhoamostra)
print("-----------------------------------")

# vamos dividir as IDADES em varios grupinhos para calcular a media delas
...
print('Intervalo de confiança com 90% das idades :  ', intervaloconfianca)
print("-----------------------------------")
print("-----------------------------------")

"""
significa que temos 90% de confiança que a media das idades das 
pessoas do arquivo planilha 3 é de 31 até 32 anos, isso na tendencia central
