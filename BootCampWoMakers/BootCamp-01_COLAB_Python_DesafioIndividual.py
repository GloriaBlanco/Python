# -*- coding: utf-8 -*-
"""Desafio Individual Python Glória.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lQl685F8qRvVa1TI6AOsR0-52XRiIj__
"""
...
moda = vida.groupby('Profissão')["Duração do sono"].agg(pd.Series.mode)
print(f'---------------------------Moda', mediana)
